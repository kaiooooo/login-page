...
Nesse projeto, foi elaborado uma página de login, podendo servir como layout para várias páginas. Quando usado, será preciso fazer o funcionamento dele com a página principal de seu site.
